...
const Blogs = () => {
  return (
    ...
    <section class="text-gray-600 body-font overflow-hidden">
        <h1 className='text-center font-bold text-3xl text-black mt-24'>Top Blogs to read about mental health</h1>
  <div class="container px-5 py-24 mx-auto">
    <div class="flex flex-wrap -m-12">
      <div class="p-12 md:w-1/2 flex flex-col items-start">
        <span class="inline-block py-1 px-2 rounded bg-red-50 text-red-500 text-xs font-medium tracking-widest">CATEGORY</span>
        ...
        <a class="inline-flex items-center">
          <img alt="blog" src="https://dummyimage.com/104x104" class="w-12 h-12 rounded-full flex-shrink-0 object-cover object-center"></img>
      ...
      <div class="p-12 md:w-1/2 flex flex-col items-start">
        ...
        <div class="flex items-center flex-wrap pb-4 mb-4 border-b-2 border-gray-100 mt-auto w-full">
          <a class="text-red-500 inline-flex items-center hover:cursor-pointer">
        ...
        <a class="inline-flex items-center">
          <img alt="blog" src="https://dummyimage.com/103x103" class="w-12 h-12 rounded-full flex-shrink-0 object-cover object-center"></img>
          <span class="flex-grow flex flex-col pl-4">
